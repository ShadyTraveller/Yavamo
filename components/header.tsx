...
import { NavSection } from "@/app/page";
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-semibold text-[#111]">Yavamo!</span>
          </div>
          ...
          {/* CTA Button */}
          <button className="hidden sm:block bg-[#F5A623] text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-[#E09515] transition-colors">
            Get a Quote
          </button>
        </div>
